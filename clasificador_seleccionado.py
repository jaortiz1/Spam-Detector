...
#Code
spam_subjects = readEmails("Enron-Spam-Splited/train/no_deseado/") #9494 correos no deseados 
ham_subjects = readEmails("Enron-Spam-Splited/train/legítimo/")   #10828 correos legítimos
